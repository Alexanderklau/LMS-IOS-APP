...
- (void)viewDidLoad
{
    ...
    if (isIos7 >= 7 && __IPHONE_OS_VERSION_MAX_ALLOWED > __IPHONE_6_1)
    {
        ...
        ((UIImageView *)statusBarView).backgroundColor = RGBA(0,212,38,1);
        [self.view addSubview:statusBarView];
    }
    
    _navView = [[UIImageView alloc] initWithFrame:CGRectMake(0.f, StatusbarSize, self.view.frame.size.width, 44.f)];
    ((UIImageView *)_navView).backgroundColor = RGBA(0,212,38,1);
    ...
    [lbtn setTitle:@"设置" forState:UIControlStateNormal];
    ...
    [rbtn setTitle:@"服务" forState:UIControlStateNormal];
